...
int main(int argc, char **argv)
{
    ...
    // carregando texturas
    texChao = carregaTextura("assets/173.png");
    texTorre = carregaTextura("assets/009.png");
    texDegrau = carregaTextura("assets/487.png");
    texEsfera = carregaTextura("assets/583.png");
    texLava = carregaTextura("assets/692.png");
